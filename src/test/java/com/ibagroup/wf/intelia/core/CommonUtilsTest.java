...
public class CommonUtilsTest {
    ...
    public void testNormalizeDatesForIP() {
        try {
            String[] dates = CommonStringUtils.normalizeDatesForIP("21.01.2017", "05.03.2017", 3);
            String[] expecteds = {"2016-10-21", "2017-03-05"};
            Assert.assertArrayEquals(expecteds, dates);

            dates = CommonStringUtils.normalizeDatesForIP("21.02.2017", "05.03.2017", 3);
            String[] expecteds1 = {"2016-11-21", "2017-03-05"};
            Assert.assertArrayEquals(expecteds1, dates);

            dates = CommonStringUtils.normalizeDatesForIP("21.03.2017", "05.03.2017", 3);
            String[] expecteds2 = {"2016-12-21", "2017-03-05"};
            Assert.assertArrayEquals(expecteds2, dates);
        
            dates = CommonStringUtils.normalizeDatesForIP("21.11.2017", "05.03.2017", 3);
            String[] expecteds3 = {"2017-08-21", "2017-03-05"};
            Assert.assertArrayEquals(expecteds3, dates);

            dates = CommonStringUtils.normalizeDatesForIP("21.11.2017", "05.03.2017", 6);
    ...
    public void testNormalizeDatesForATMX() {
        String[] dates = CommonStringUtils.normalizeDatesForATMX("21.02.2017", "21.02.2017", 2);
        String[] expecteds1 = {"JAN2017", "FEB2017"};
        Assert.assertArrayEquals(expecteds1, dates);

        dates = CommonStringUtils.normalizeDatesForATMX("21.02.2017", "02.03.2017", 3);
        String[] expecteds2 = {"DEC2016", "JAN2017", "FEB2017", "MAR2017"};
        Assert.assertArrayEquals(expecteds2, dates);

        dates = CommonStringUtils.normalizeDatesForATMX("21.02.2017", "02.03.2017", 7);
